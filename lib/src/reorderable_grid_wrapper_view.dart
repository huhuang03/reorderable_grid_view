...
class ReorderableGridWrapperView extends StatefulWidget {
...
class ReorderableGridWrapperViewState extends State<ReorderableGridWrapperView> with TickerProviderStateMixin<ReorderableGridWrapperView> {
  ...
  static ReorderableGridWrapperViewState of(BuildContext context) {
    return context.findAncestorStateOfType<ReorderableGridWrapperViewState>()!;
  }
